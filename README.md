...
- [NextCloudPi](https://nextcloudpi.com/) - Nextcloud preinstalled and preconfigured, with management interface and all the tools needed to self host private data. Installation imageges for Raspberry Pi, Odroid, Rock64, Docker, and Armbian/Debian curl installer. ([Source Code](https://github.com/nextcloud/nextcloudpi)) `GPL` `Bash` `PHP`
